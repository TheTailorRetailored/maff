...
assert.equal(mcpServerVersion, "1.6.2-gap-frontier-routing")
...
for (const prop of ["resolution_kind", "resolution_role"]) assert.ok(gapProps[prop], `create_gap schema must advertise ${prop}`)
