...
export const mcpServerVersion = "1.6.7-idempotent-publication"
...
export const toolDefinitions: ToolDef[] = [
  ...
  tool("publish_manuscript", "Idempotently release the latest successful exact PaperBuild after publication readiness, mark the project complete, retire residual active work, and surface only its final PDF. Repeated calls return the existing identical package.", "editor", objectSchema({ workspace_id: s, project_id: s, manuscript_version_id: s }, ["workspace_id", "project_id"]), scopes.maffReview),
