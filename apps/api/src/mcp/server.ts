...
export const mcpServerVersion = "0.3.1-depends-on-dag"
...
export const toolDefinitions: ToolDef[] = [
  ...
  tool("create_claim", "Create a rich Claim node for a theorem, conjecture, lemma, proposition, reduction, or counterexample statement. Claim-to-Claim proof structure should use depends_on; reverse supports are computed when needed. Normally call maff_bootstrap first unless the user explicitly supplied a workspace_id and requested this exact operation.", "editor", objectSchema({ workspace_id: s, problem_id: s, title: s, statement: s, motivation: s, claim_kind: s, role: s, claim_status: s, proof_status: s, lean_status: s, depends_on: strArray, blocked_by: strArray, area: s, short_title: s, body_sections: anyObj, confidence: n }, ["workspace_id", "title", "statement", "claim_kind", "role"])),
