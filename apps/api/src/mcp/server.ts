...
export const mcpServerVersion = "1.6.2-gap-frontier-routing"
...
export const toolDefinitions: ToolDef[] = [
  ...
  tool("create_gap", "Create a typed Gap targeted to a claim, exact manuscript, proof obligation, artifact, external review, or audit finding. When the repair is already executable, set resolution_kind and resolution_role so frontier reconciliation preserves the intended specialist handoff.", "editor", objectSchema({ workspace_id: s, project_id: s, claim_id: s, proof_attempt_id: s, route_id: s, title: s, description_markdown: s, severity: s, status: s, suggested_resolution: s, resolution_kind: s, resolution_role: s, target_object_type: s, target_object_id: s, external_review_id: s, audit_finding_id: s }, ["workspace_id", "project_id", "severity"])),
