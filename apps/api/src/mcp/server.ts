...
const idempotentToolNames = new Set(["rebuild_quartz_site", "align_project_release_state", "adopt_reviewed_manuscript_successor", "promote_manuscript_to_submission_candidate", "prepare_external_review_package", "publish_manuscript"])
