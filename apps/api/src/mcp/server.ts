...
const idempotentToolNames = new Set(["rebuild_quartz_site", "align_project_release_state", "adopt_reviewed_manuscript_successor", "repair_exact_version_citation_metadata", "promote_manuscript_to_submission_candidate", "prepare_external_review_package", "publish_manuscript", "validate_review_round", "record_review_round", "submit_run_outcome"])
