...
const idempotentToolNames = new Set(["rebuild_quartz_site", "align_project_release_state", "adopt_reviewed_manuscript_successor", "repair_exact_version_citation_metadata", "promote_manuscript_to_submission_candidate", "prepare_external_review_package", "publish_manuscript"])
...
export const mcpServerVersion = "1.10.0-exact-version-citation-repair"
export const expectedMcpToolCount = 114
...
export const toolDefinitions: ToolDef[] = [
  ...
  tool("submit_run_outcome", "Complete an AgentRun with a durable state-owned handoff. The returned continuation is authoritative. A fresh author-disjoint reviewer context may drain consecutive eligible review gates in the same chat; caller-supplied handoff text cannot force unnecessary new chats.", "editor", objectSchema({ workspace_id: s, agent_run_id: s, completed_work: strArray, changed_objects: strArray, evidence_generated: strArray, checks_performed: strArray, problems_encountered: strArray, unresolved_uncertainty: strArray, gaps_created: strArray, gaps_resolved: strArray, next_action: anyObj }, ["workspace_id", "agent_run_id", "completed_work", "changed_objects", "evidence_generated", "checks_performed", "problems_encountered", "unresolved_uncertainty", "gaps_created", "gaps_resolved", "next_action"])),
