...
Run an invariant, release, migration, or forensic audit against an immutable snapshot. Reconstruct readiness from raw provenance, exact artifacts, assignments, reviews, gaps, imports, and frontier state. Do not edit project objects, invalidate reviews, create operational gaps, or perform repairs in this chat.
